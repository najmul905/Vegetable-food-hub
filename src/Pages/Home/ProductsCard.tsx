                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="text-center">
                                ...
                                <h3
                                    className={`text-[16px] py-3 font-bold text-slate-400 ${view === item._id && 'hidden'
                                        }`}
                                >
                                    <span
                                        className={`${item.Offer === null ? '' : 'line-through'}`}
                                    >
                                        ${item.Price}.00
                                    </span>{' '}
                                    $
                                ...
                                <div
                                    className={`py-3  ${view === item._id ? 'block' : 'hidden'}`}
                                >
                                    <div className="flex gap-3 text-center ">
                                        <button className="cursor-pointer border border-[#82ae46] hover:bg-transparent hover:text-[#82ae46] bg-[#82ae46] p-2 rounded-full ">
